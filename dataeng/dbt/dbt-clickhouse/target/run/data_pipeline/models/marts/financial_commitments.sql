    ...
    create  table
      "warehouse"."main"."financial_commitments__dbt_tmp"
...
WITH order_aggregates AS (
    ...
    FROM (SELECT department_id, product_card_id, order_item_total, order_status FROM "warehouse"."main"."dim_order" LIMIT 50000) o
