...
conf = {'bootstrap.servers': "localhost:9092", 'group.id': "dataeng.de-zoomcamp-form-data", 'auto.offset.reset': 'earliest'}
consumer = Consumer(conf)

# # Subscribe to the Kafka topic
# topic = 'dataeng-de-form-submissions'
...
def consume_data(bootstrap_servers, topic):
    conf = {'bootstrap.servers': bootstrap_servers, 'group.id': 'dataeng-supply-chain', 'auto.offset.reset': 'earliest'}
    consumer = Consumer(conf)
    consumer.subscribe([topic])
