        ...
        insert into `etl`.`mart_overall_performance__dbt_backup`
        ("os.year", "os.month", "month_name", "total_sales", "total_profit", "avg_profit_margin", "avg_actual_shipment_days", "avg_scheduled_shipment_days")
